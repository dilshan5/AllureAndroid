...
private const val FAILURES_PATH = "AllureAndroid/failures"
...
private val SCREENSHOT_FAILURE_PATH =
    "$externalStorageDirectoryPath/${Environment.DIRECTORY_PICTURES}/$screenshotsRelativePath/$FAILURES_PATH/"
 ...
 */
@Suppress("FunctionName") // factory method
fun ScreenShotRuleChain(): RuleChain = ScreenShotRuleChain(FAILURES_PATH)